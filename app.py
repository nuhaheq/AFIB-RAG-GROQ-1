...
# Flexible import untuk HuggingFaceEmbeddings
try:
...
"""
                ...
                # Senarai model Groq aktif mengikut keutamaan
                candidate_models = [
                ...
                if not answer_text:
                    st.error(f"Gagal memanggil semua model Groq. Ralat terakhir: {last_error}")
                else:
